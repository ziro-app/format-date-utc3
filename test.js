...
const formatDateUTC3 = require('./index')

test('1', t => {
    const valueToTest = false
    const calculated = t.throws(() => formatDateUTC3(valueToTest)).message
    const expected = 'formatDateUTC3 expects a Date instance'
...
test('20', t => {
    ...
    const calculated = formatDateUTC3(valueToTest)
    const expected = '17/12/1995 08:24:00'
    t.deepEqual(calculated, expected)
})
test('21', t => {
...
test('22', t => {
    ...
    const calculated = formatDateUTC3(valueToTest)
    const expected = '01/12/1995 08:24:00'
    t.deepEqual(calculated, expected)
})
test('23', t => {
    const valueToTest = new Date('December 1, 2020 03:24:00')
    const calculated = formatDateUTC3(valueToTest)
    const expected = '01/12/2020 08:24:00'
    t.deepEqual(calculated, expected)
})
test('24', t => {
...
test('25', t => {
    ...
    const calculated = formatDateUTC3(valueToTest)
    const expected = '01/12/2020 05:00:00'
    t.deepEqual(calculated, expected)
})
test('26', t => {
